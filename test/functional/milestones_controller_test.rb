...
class MilestonesControllerTest < ActionController::TestCase
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post :create, milestone: { active: @milestone.active, description: @milestone.description, end_date: @milestone.end_date, estimated_time: @milestone.estimated_time, start_date: @milestone.start_date }
    end
  ...
  test "should update milestone" do
    put :update, id: @milestone, milestone: { active: @milestone.active, description: @milestone.description, end_date: @milestone.end_date, estimated_time: @milestone.estimated_time, start_date: @milestone.start_date }
    assert_redirected_to milestone_path(assigns(:milestone))
  end
