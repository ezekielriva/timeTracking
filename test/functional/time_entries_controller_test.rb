...
class TimeEntriesControllerTest < ActionController::TestCase
  ...
  test "should create time_entry" do
    assert_difference('TimeEntry.count') do
      post :create, time_entry: { end_time: @time_entry.end_time, note: @time_entry.note, start_time: @time_entry.start_time }
    end
  ...
  test "should update time_entry" do
    put :update, id: @time_entry, time_entry: { end_time: @time_entry.end_time, note: @time_entry.note, start_time: @time_entry.start_time }
    assert_redirected_to time_entry_path(assigns(:time_entry))
  end
